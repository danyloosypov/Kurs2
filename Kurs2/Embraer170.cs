...
namespace Kurs2
{
    public partial class Embraer170 : Form
    {
        public SqlConnection sqlconn;
        public int orderID;
        public int flightID;
        public int aircraft_id = 2;
        private bool isselected;

        public Embraer170(SqlConnection sqlconn, int orderID, int flightID)
        {
            InitializeComponent();
        ...
        private void Embraer170_Load(object sender, EventArgs e)
        {
