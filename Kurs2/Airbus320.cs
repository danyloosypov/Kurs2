...
namespace Kurs2
{
    public partial class Airbus320 : Form
    {
        public SqlConnection sqlconn;
        public int orderID;
        public int flightID;
        public int aircraft_id = 7;
        private bool isselected;
        public Airbus320(SqlConnection sqlconn, int orderID, int flightID)
        {
            InitializeComponent();
        ...
        private void SeatClick(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(row) >= 3 && Convert.ToInt32(row) <= 27)
            {
                cnt = 1 * cnt;
            }
        ...
        private void Airbus320_Load(object sender, EventArgs e)
        {
