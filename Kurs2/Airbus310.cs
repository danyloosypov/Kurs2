...
namespace Kurs2
{
    public partial class Airbus310 : Form
    {
        public SqlConnection sqlconn;
        public int orderID;
        public int flightID;
        public int aircraft_id = 5;
        private bool isselected;
        public Airbus310(SqlConnection sqlconn, int orderID, int flightID)
        {
            InitializeComponent();
        ...
        private void SeatClick(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(row) >= 1 && Convert.ToInt32(row) <= 2)
            {
                cnt = 3 * cnt;
            } else if (Convert.ToInt32(row) >= 17 && Convert.ToInt32(row) <= 21)
            {
                cnt = 2 * cnt;
            }
            else if (Convert.ToInt32(row) >= 25 && Convert.ToInt32(row) <= 43)
            {
                cnt = 1 * cnt;
            }
        ...
        private void Airbus310_Load(object sender, EventArgs e)
        {
